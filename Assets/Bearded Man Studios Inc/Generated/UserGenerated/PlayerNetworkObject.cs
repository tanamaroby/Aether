...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class PlayerNetworkObject : NetworkObject
	{
		...
		public event FieldEvent<float> velocityChanged;
		public InterpolateFloat velocityInterpolation = new InterpolateFloat() { LerpT = 0.15f, Enabled = true };
		...
		protected override void ReadPayload(BMSByte payload, ulong timestep)
		{
			...
			_velocity = UnityObjectMapper.Instance.Map<float>(payload);
		...
		protected override void ReadDirtyFields(BMSByte data, ulong timestep)
		{
			...
			if ((0x4 & readDirtyFlags[0]) != 0)
			{
				...
				{
					velocityInterpolation.target = UnityObjectMapper.Instance.Map<float>(data);
					velocityInterpolation.Timestep = timestep;
				}
				else
				{
					_velocity = UnityObjectMapper.Instance.Map<float>(data);
					RunChange_velocity(timestep);
				}
			}
